  ...
  const { overlayProps, underlayProps } = (0, import_overlays.useOverlay)(
    {
      ...
      isDismissable,
      isKeyboardDismissDisabled,
      shouldCloseOnInteractOutside: shouldCloseOnInteractOutside ? shouldCloseOnInteractOutside : (element) => (0, import_aria_utils2.ariaShouldCloseOnInteractOutside)(element, triggerRef, state)
    },
    popoverRef
  );
  const {
...
function usePopover(originalProps) {
  ...
  const getDialogProps = (props2 = {}) => ({
    ...
    "data-placement": (0, import_aria_utils3.getArrowPlacement)(ariaPlacement, placementProp),
    ...(0, import_utils2.mergeProps)(focusProps, dialogProps, dialogPropsProp, props2),
  ...
  const placement = (0, import_react3.useMemo)(
    () => (0, import_aria_utils3.getShouldUseAxisPlacement)(ariaPlacement, placementProp) ? ariaPlacement || placementProp : placementProp,
...
var Popover = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const overlay = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_overlays4.Overlay, { disableFocusManagement: true, portalContainer: context.portalContainer, children: content });
...
var PopoverContent = (0, import_system4.forwardRef)((props, _) => {
  ...
  const RemoveScrollWrapper = (0, import_react6.useCallback)(
    ({ children: children2 }) => {
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react_remove_scroll.RemoveScroll, { enabled: shouldBlockScroll && isOpen, removeScrollBar: false, children: children2 });
    },
    [shouldBlockScroll, isOpen]
  );
  const contents = disableAnimation ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RemoveScrollWrapper, { children: content }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_framer_motion2.LazyMotion, { features: import_framer_motion2.domAnimation, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    import_framer_motion2.m.div,
    {
      animate: "enter",
      exit: "exit",
      ...
      ...motionProps,
      children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RemoveScrollWrapper, { children: content })
    }
  ) });
