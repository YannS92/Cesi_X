...
function useAutocomplete(originalProps) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    (_a2 = inputRef == null ? void 0 : inputRef.current) == null ? void 0 : _a2[action]();
    if (action === "blur")
  ...
  const getPopoverProps = (props2 = {}) => {
    ...
    return {
      ...
      shouldCloseOnInteractOutside: (popoverProps2 == null ? void 0 : popoverProps2.shouldCloseOnInteractOutside) ? popoverProps2.shouldCloseOnInteractOutside : (element) => (0, import_aria_utils.ariaShouldCloseOnInteractOutside)(element, inputWrapperRef, state, shouldFocus)
    };
  };
